...
SYMBOLS=(${VOLSCOPE_EXAMPLE_SYMBOLS:-AAPL AMZN GOOGL META MSFT NVDA QQQ SPY TSLA})
DATES=(${VOLSCOPE_EXAMPLE_DATES:-2026-07-09 2026-07-10})
...
printf '  VOLSCOPE_DATA_ROOT=%q ./scripts/start.sh\n' "$TARGET_ROOT"
