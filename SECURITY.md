...
VolScope is pre-1.0. Security fixes target the latest `main` branch
...
<jiangjingzhe2004@gmail.com> with the subject `VolScope Security`.
...
declares `rkyv 0.7` as an optional dependency. VolScope does not
